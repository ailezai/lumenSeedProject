            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form action="{{ auto_url('system/role/add_submit') }}" method="post" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-10 col-lg-10">
                                    <input type="text" class="form-control" id="page-edit-form-alias" name="alias" autocomplete="off" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-10 col-lg-10">
                                    <input type="text" class="form-control" id="page-edit-form-group" name="group" autocomplete="off" required>
                            ...
                            <input type="hidden" name="parent_role_id" value="{{ $parentRoleId }}">
