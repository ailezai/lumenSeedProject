        ...
        {{-- 操作 --}}
            <div class="ibox-content m-b-sm border-bottom">
                @if(session()->get('admin_user_id') == 1)
                    <a href="{{ auto_url('system/user/index?all=1') }}" class="btn btn-w-m btn-info" >查看所有管理员</a>
                @endif
                <a href="{{ auto_url('system/user/add_page') }}" class="btn btn-w-m btn-info" >添加管理员</a>
            </div>
        {{-- 操作 --}}
                                ...
                                @foreach($list as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($item->admin_user_id != session()->get('admin_user_id'))
                                                <a class="btn btn-xs btn-warning" href="{{ auto_url('system/user/edit_page?admin_user_id='.$item->admin_user_id) }}"><i class="fa fa-pencil"></i></a>
