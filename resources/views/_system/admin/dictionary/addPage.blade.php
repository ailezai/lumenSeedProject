...
<form action="{{ auto_url('system/dictionary/add_submit') }}" method="post" class="form-horizontal"
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        <input type="text" class="form-control" id="pjax-form-desc" name="desc" autocomplete="off" required>
