...
<form action="{{ auto_url('system/permission/edit_submit') }}" method="post" class="form-horizontal"
            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        <input type="text" class="form-control" id="pjax-form-alias" name="alias" value="{{ $permission->alias }}" autocomplete="off" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        <input type="text" class="form-control" id="pjax-form-name" name="name" value="{{ $permission->name }}" autocomplete="off" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        <select class="form-control" id="pjax-form-method" name="methods" required>
                            @foreach($requestMethod as $item)
                                <option value="{{ $item[0] }}" @if($item[0] == $permission->method) selected @endif>{{ $item[1] }}</option>
                            @endforeach
                        </select>
                        <span class="help-block m-b-none"></span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        <textarea id="pjax-form-path"  name="path" class="form-control" rows="5" style="resize: none;">{{ str_replace(',', "\r\n", $permission->path) }}</textarea>
                        <span class="help-block m-b-none"></span>
                    </div>
                </div>
